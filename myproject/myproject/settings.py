...
SECRET_KEY = os.environ.get("SECRET_KEY", "django-insecure-s%mpbkr(69up*h%nw%@cdun3j^(s&g8$(9*-l)*2iqtgp$^w&u")
...
# Use absolute path to ensure correct URLs on all routes (e.g., /about.html)
STATIC_URL = "/static/"
STATICFILES_DIRS = [
